...
int main()
{
    ...
    while (1)
    {
        ...
        std::cout << "Multiple arrays: ";
        {
            ...
            int **a2d = new int *[50]; // allocate 200 bytes of memoery ( for 50 integerpointers)
            for (int i = 0; i < 50; i++)
                a2d[i] = new int[50];
            ...
            for (int i = 0; i < 50; i++)
                delete[] a2d[i]; // this is very important to take into account, you have to delete every array of integers.
