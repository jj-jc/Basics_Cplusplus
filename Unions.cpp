...
int main()
{
    Union u; // this is a struct that stores a 4 byte of data, because it can store a float.
    u.a = 2.0f;
    std::cout << u.a << ", " << u.b << std::endl; // the information stored is ridden by a float pointer or by a int pointer
